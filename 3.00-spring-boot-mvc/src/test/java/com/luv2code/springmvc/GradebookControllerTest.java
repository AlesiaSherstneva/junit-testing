...
public class GradebookControllerTest {
    ...
    @Test
    public void studentInformationStudentDoesNotExistRequest() throws Exception {
    ...
    @Test
    public void createValidGradeHttpRequestGradeTypeDoesNotExist() throws Exception {
        MvcResult mvcResult = mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
    ...
    public void deleteValidGradeHttpRequest() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(get("/grades/{id}/{gradeType}", 1, "math"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void deleteNonValidGradeHttpRequest() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/grades/{id}/{gradeType}", 2, "literature"))
                .andExpect(status().isOk())
                .andReturn();

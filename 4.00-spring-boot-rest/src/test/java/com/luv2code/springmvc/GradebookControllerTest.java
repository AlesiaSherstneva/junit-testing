...
public class GradebookControllerTest {
    ...
    @Test
    public void createNonValidGradeHttpRequestGradeTypeDoesNotExist() throws Exception {
        mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
    ...
    @Test
    public void deleteValidGradeHttpRequestStudentDoesNotExist() throws Exception {
    ...
    @Test
    public void deleteNonValidGradeHttpRequestGradeTypeDoesNotExist() throws Exception {
